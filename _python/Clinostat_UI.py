...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frameCD_spinBox_2 = QtWidgets.QSpinBox(self.frame_2)
        self.frameCD_spinBox_2.setGeometry(QtCore.QRect(40, 50, 121, 22))
        self.frameCD_spinBox_2.setPrefix("")
        self.frameCD_spinBox_2.setMinimum(-200)
        self.frameCD_spinBox_2.setMaximum(200)
        self.frameCD_spinBox_2.setObjectName("frameCD_spinBox_2")
        ...
        self.framePW_spinBox.setMinimum(2)
        ...
        self.framePI_spinBox.setMinimum(390)
        self.framePI_spinBox.setMaximum(100000)
        ...
        self.corePI_spinBox.setMinimum(390)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.frameCD_spinBox_2.setSuffix(_translate("MainWindow", " mA"))
        ...
        self.frameMS_comboBox.setItemText(0, _translate("MainWindow", "FULL"))
        self.frameMS_comboBox.setItemText(1, _translate("MainWindow", "1/2"))
        self.frameMS_comboBox.setItemText(2, _translate("MainWindow", "1/4"))
        self.frameMS_comboBox.setItemText(3, _translate("MainWindow", "1/8"))
        self.frameMS_comboBox.setItemText(4, _translate("MainWindow", "1/16"))
        self.frameMS_comboBox.setItemText(5, _translate("MainWindow", "1/32"))
        self.frameMS_comboBox.setItemText(6, _translate("MainWindow", "1/64"))
        self.frameMS_comboBox.setItemText(7, _translate("MainWindow", "1/128"))
        ...
        self.coreMS_comboBox.setItemText(0, _translate("MainWindow", "FULL"))
        self.coreMS_comboBox.setItemText(1, _translate("MainWindow", "1/2"))
        self.coreMS_comboBox.setItemText(2, _translate("MainWindow", "1/4"))
        self.coreMS_comboBox.setItemText(3, _translate("MainWindow", "1/8"))
        self.coreMS_comboBox.setItemText(4, _translate("MainWindow", "1/16"))
        self.coreMS_comboBox.setItemText(5, _translate("MainWindow", "1/32"))
        self.coreMS_comboBox.setItemText(6, _translate("MainWindow", "1/64"))
        self.coreMS_comboBox.setItemText(7, _translate("MainWindow", "1/128"))
