...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.startImage_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.startImage_pushButton.setGeometry(QtCore.QRect(610, 400, 171, 41))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../Flashlapse_NEO/_image/Start-Scheduler.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.startImage_pushButton.setIcon(icon2)
        self.startImage_pushButton.setIconSize(QtCore.QSize(10, 10))
        self.startImage_pushButton.setObjectName("startImage_pushButton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.startImage_pushButton.setText(_translate("MainWindow", "START IMAGING"))
